...
export const PROVIDER_DEFINITIONS: ProviderDefinition[] = [
  ...
  },
  {
    ...
    name: 'iPollo',
    icon: '🟦',
    placeholder: 'ipollo-api-key',
    model: 'Multi-Model',
    requiresApiKey: true,
    defaultBaseUrl: 'https://token-gateway.clawos.metacarbon-inc.com/v1',
    showBaseUrl: true,
    showModelId: true,
    modelIdPlaceholder: 'qwen3.5-plus',
    defaultModelId: 'qwen3.5-plus',
    category: 'compatible',
    envVar: 'IPOLLO_API_KEY',
    supportedAuthModes: ['api_key'],
    defaultAuthMode: 'api_key',
    supportsMultipleAccounts: true,
    providerConfig: {
      baseUrl: 'https://token-gateway.clawos.metacarbon-inc.com/v1',
      api: 'openai-completions',
      apiKeyEnv: 'IPOLLO_API_KEY',
    },
  },
  {
    id: 'ollama',
